        ...
        <div className="page__inner-wrap">
          ...
          <section className="page__content" itemProp="text">
            ...
            <p>
              ...
              programming ultimately led to a career in the field of computer
              science. John connected his MIDI keyboards to his Apple ][+
              computer via a Roland MPU-401 interface and began writing MIDI
              software. This ultimately led to his career at IBM. After
              discovering his new passion for videography in 2000, John has come
              full circle back to his roots of music composition and scoring
              music for video.
            </p>
            <p>
